...
//        createEducationTable();
    ...
    public void saveEducation(User.Education education) throws SQLException {
        PreparedStatement statement = connection.prepareStatement(
    ...
    public void updateCurrentJobPosition(User.CurrentJobPosition currentJobPosition) throws SQLException {
        PreparedStatement statement = connection.prepareStatement(
