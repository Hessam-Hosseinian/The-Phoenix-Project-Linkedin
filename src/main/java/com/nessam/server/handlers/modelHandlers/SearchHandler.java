...
//        }
    ...
    // GET ip:port/search/searchHashtag/#tagName
    public String handleGetRequest(String[] splittedPath) throws SQLException, JsonProcessingException {
        ...
        else if (splittedPath[2].equals("searchHashtag")) {
            BetterLogger.INFO("Searching tags in posts with keyword: " + splittedPath[3]);
            return postController.searchPostHashtag(splittedPath[3]);
        }
